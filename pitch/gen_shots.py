...
def header(d, title, sub=None):
    d.text((22, 26), "Vistaraz", font=font(20, True), fill=WHITE)
...
def make_home():
    ...
    header(d, "")
    d.text((22, 70), "Vistaraz", font=font(30, True), fill=INDIGO)
    d.text((22, 110), "विस्ताराज़ · your mind's friend", font=font(15), fill=MUTED)
