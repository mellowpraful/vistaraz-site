#!/usr/bin/env python3
"""Generate Vistaraz.pptx pitch deck — full feature set."""
import os
...
txt(s, Inches(0.8), Inches(1.6), Inches(11.7), Inches(1.2), "Vistaraz", size=64, color=WHITE, bold=True)
txt(s, Inches(0.8), Inches(2.9), Inches(11.7), Inches(0.6), "\u0935\u093f\u0938\u094d\u0924\u093e\u0930\u093e\u091c\u093c \u2014 a friend for your mind", size=22, color=SAND)
...
txt(s, Inches(0.8), Inches(6.7), Inches(11.7), Inches(0.5),
    "Demo: vistaraz/index.html   \u00b7   In crisis: 14416 (Tele-MANAS)", size=14, color=SAND)

prs.save(os.path.join(os.path.dirname(__file__), "Vistaraz.pptx"))
print("Saved Vistaraz.pptx with", len(prs.slides._sldIdLst), "slides")
