# Vistaraz — Team Project Report

> **विस्ताराज़ — "a friend for your mind"**
...
| Heavy approach (old) | Vistaraz (new) |
|---|---|
...
| File | Purpose | Key exports to `Vistaraz` |
|---|---|---|
...
| `pitch/Vistaraz.pptx` | 14-slide pitch deck |
...
```js
Vistaraz.triage.score({ mood: 2, text: "I feel very stressed", answers: {...} })
...
- Shows on first visit (localStorage `vistaraz_toured` not set)
...
- Persisted in `localStorage` key `vistaraz_theme`
...
```js
// Reset tour
localStorage.removeItem("vistaraz_toured")
// Reset theme
localStorage.removeItem("vistaraz_theme")
...
| Tour won't show | Already completed (`vistaraz_toured`) | `localStorage.removeItem("vistaraz_toured")` |
...
Location: `pitch/Vistaraz.pptx` (14 slides)
...
```bash
cd C:\Users\Rudra\Desktop\vistaraz
...
- **Pitch deck:** `pitch/Vistaraz.pptx`
- **Demo script:** `pitch/demo-script.txt`
- **This report:** `PROJECT_REPORT.md`

---

> **Vistaraz — विस्ताराज़. A friend for your mind.**
