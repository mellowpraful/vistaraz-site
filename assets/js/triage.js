/*
 * Vistaraz — Triage Engine (mock AI, rule-based)
 * -------------------------------------------------
 * Public interface:  Vistaraz.triage.score(input) -> { severity, score, reasons, route }
 *
...
(function (global) {
  ...
  async function scoreRemote(input) {
    const ENDPOINT = global.Vistaraz && global.Vistaraz.config && global.Vistaraz.config.triageEndpoint;
  ...
  global.Vistaraz.triage = { score, routeLabel, scoreRemote };
})(window);
