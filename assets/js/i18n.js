...
(function (global) {
  ...
  const STR = {
    en: {
      ...
      "hero.sub": "Vistaraz is a trust-first mental health companion for students. Start with a 2-minute anonymous check-in — no login, no confession to a stranger on day one.",
    ...
    hi: {
      ...
      "hero.sub": "Vistaraz छात्रों के लिए विश्वास-प्रथम मानसिक स्वास्थ्य साथी है। 2 मिनट की गुमनाम चेक-इन से शुरू करें — कोई लॉगिन नहीं।",
    ...
    mr: {
      ...
      "hero.sub": "Vistaraz हा विद्यार्थ्यांसाठी विश्वासावर आधारित मानसिक आरोग्य साथीदार आहे. 2 मिनिटांच्या अनामिक चेक-इनने सुरुवात करा — कोणतेही लॉगिन नाही.",
    ...
    gu: {
      ...
      "hero.sub": "Vistaraz વિદ્યાર્થીઓ માટે વિશ્વાસ-પ્રથમ માનસિક આરોગ્ય સાથી છે. 2 મિનિટની બિન-ઓળખીતી ચેક-ઇનથી શરૂ કરો — કોઈ લૉગિન નહીં.",
