...
counselor-shortage problem; it's a first-step problem.** Vistaraz lowers that first step
...
## Pitch deck
`pitch/Vistaraz.pptx` — 10 slides. Regenerate with `python pitch/build_deck.py`.
